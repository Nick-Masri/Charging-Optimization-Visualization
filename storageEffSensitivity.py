...
#%%
reserve = pd.read_excel("data/sensitivityAnalysis/storageEffSensitivityS3.xlsx", header=None)
reserveD = pd.read_excel("data/sensitivityAnalysis/storageEffSensitivityD3.xlsx", header=None)
#%%
...
plt.xlabel("Storage Charging Efficiency", fontsize=14)
# plt.title("Electricity Cost Vs. Storage Charging Efficiency", fontsize=18, pad=5, wrap=True)
plt.savefig("storageEffSens.png")
plt.show()
